...
export interface ApiGistAnswerGistAnswer extends Struct.CollectionTypeSchema {
  collectionName: 'gist-answers';
  info: {
    displayName: 'gist-answer';
    pluralName: 'gist-answers';
    singularName: 'gist-answer';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiGistAttributionGistAttribution
  extends Struct.CollectionTypeSchema {
  collectionName: 'gist-attributions';
  info: {
    displayName: 'Gist Attribution';
    pluralName: 'gist-attributions';
    singularName: 'gist-attribution';
  };
  options: {
    draftAndPublish: false;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::gist-attribution.gist-attribution'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiHomepageHomepage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    cards: Schema.Attribute.Component<'cards-section.cards-section', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiNavbarNavbar extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    menu_items: Schema.Attribute.Component<'menu.item', true>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiTitlefirstpgHomeTitlefirstpgHome
  extends Struct.SingleTypeSchema {
  collectionName: 'titlefirstpg_homes';
  info: {
    displayName: 'Titlefirstpg_Home';
    pluralName: 'titlefirstpg-homes';
    singularName: 'titlefirstpg-home';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::titlefirstpg-home.titlefirstpg-home'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
